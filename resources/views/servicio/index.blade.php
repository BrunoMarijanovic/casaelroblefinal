                                ...
                                <tbody>
                                    @foreach ($servicios as $servicio)
                                        <tr>
											...
											<td>{{ $servicio->parrafo01ES }}</td>
											<td>{{ $servicio->parrafo01CAT }}</td>
											<td>{{ $servicio->parrafo01EN }}</td>
											<td>{{ $servicio->parrafo01FR }}</td>
											<td>{{ $servicio->parrafo02ES }}</td>
											<td>{{ $servicio->parrafo02CAT }}</td>
											<td>{{ $servicio->parrafo02EN }}</td>
											<td>{{ $servicio->parrafo02FR }}</td>
