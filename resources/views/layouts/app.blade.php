...
<head>
    ...
    <title>{{ 'ADMIN Casa el Roble' }}</title>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    @if (Route::has('login'))
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('imgs.index') }}">{{ __('Imágenes') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('normas.index') }}">{{ __('Normas') }}</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('resenas.index') }}">{{ __('Resenas') }}</a>
                        </li>
                    @endif
                    </ul>
